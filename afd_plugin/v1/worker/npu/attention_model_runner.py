...
class AFDNPUAttentionModelRunner(NPUModelRunner):
    ...
    def _build_attention_metadata_with_async_moe_ubatches(
        ...
        num_reqs_padded = int(
            values.get("num_reqs_padded") or len(num_scheduled_tokens_np),
        )
        ...
        stage_plan = plan_async_moe_stages(
            ...
            num_stages=self.afd_async_extra_info.async_moe_num_ubatches,
        ...
        if stage_plan is None:
            return full_metadata
        ubatch_slices, stage_actual_token_counts = stage_plan
        ...
        stage_attn_metadata, _ = self._build_attention_metadata_with_ubatches(
            *stage_args,
            ...
            async_moe_stages=ubatch_slices,
            **stage_kwargs,
        )
        self._afd_pending_metadata = self._build_afd_metadata(
            ubatch_slices,
